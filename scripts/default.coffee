...
# Ninja
  ...
  ask = false
  authenticated = false
  authorized = ['yingcong', 'oswaldyeo', 'stevesutanto', 'yasmin', 'bryanlee', 'mrscba', 'luciano', 'intan', 'russellkua', 'yeehwee', 'billyglintsbatam', 'Andi', 'Bandi', 'HendraAhui', 'JhonChrs', 'Monata S', 'Villa', 'vinsen']
